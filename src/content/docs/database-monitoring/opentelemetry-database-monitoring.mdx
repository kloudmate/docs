...
---
In addition to the eBPF-based [Database Access Monitoring (DAM)](/database-monitoring/Database Access Monitoring _DAM_/), you can use OpenTelemetry SDK instrumentation to capture detailed database query traces with custom attributes.
...
- When combined [Manual Instrumentation](/database-monitoring/APM/Manual Instrumentation/) for the business context
...
<hint type="info">
  For zero-configuration kernel-level profiling, see [Database Access Monitoring (DAM)](/database-monitoring/Database Access Monitoring _DAM_/). For deep query analytics with execution plans and schema discovery, see [Direct Database Monitoring](/database-monitoring/Direct Database Monitoring/).
</hint>
