...
- [ML Classifier Deployment Guide](./ml-classifier-deployment-guide.mdx)

<hint type="info">
  For deeper query analytics, including execution plans and schema discovery, see [Direct Database Monitoring](../direct-database-monitoring.mdx). For distributed trace context from your application SDKs, see [OpenTelemetry Database Monitoring](../opentelemetry-database-monitoring.mdx).
</hint>
...
- The eBPF Receiver must be enabled in the agent configuration (see [Configuration](../../km-agent/configuration.mdx)).
