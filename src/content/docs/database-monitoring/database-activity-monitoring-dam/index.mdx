...
- [ML Classifier Deployment Guide](/database-monitoring/database-activity-monitoring-dam/ml-classifier-deployment-guide/)

<hint type="info">
  For deeper query analytics, including execution plans and schema discovery, see [Direct Database Monitoring](/database-monitoring/direct-database-monitoring/). For distributed trace context from your application SDKs, see [OpenTelemetry Database Monitoring](/database-monitoring/opentelemetry-database-monitoring/).
</hint>
...
- The eBPF Receiver must be enabled in the agent configuration (see [Configuration](/km-agent/configuration/)).
