...
The new user data only executes on **newly launched**instances. To deploy on your existing 50 instances, choose one of the following:***Option A: Instance Refresh***
...
**How it works:**- Keeps**90% of instances healthy** at all times
...
**How it works:**- Runs on**10 instances at a time** (--max-concurrency 10)
- All 50 instances done in **5 batches**
- Stops if more than 5 instances fail (--max-errors 5)
- **Zero downtime**— no instance restarts required**Monitor progress:**
