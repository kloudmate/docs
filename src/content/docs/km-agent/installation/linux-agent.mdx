...
sidebar:
  order: 3
---
This document provides clear instructions for installing the **KloudMate Agent**on a Linux machine​.**Supported Platforms:**Debian/Ubuntu, RHEL/CentOS.
...
## **Accessing Your Data**View all data in these KloudMate sections:**1. Infrastructure Monitoring**
...
[Log Explorer](https://docs.kloudmate.com/log-explorer)

## Install Agent

**Step 1:**Navigate to the**Settings → Agents**section in your KloudMate account.**Step 2:**Select **Linux**from the list of available integrations.**Step 3:**Copy and run the Linux agent install command in your terminal to download and install the agent.

![image](./images/linux-agent-1.png)

**Step 4:** un the agent status command to check if the agent is active.
