...
- **Dashboards:** rebuilt views for container-level and host-level performance
...
**Step 1:**Navigate to the**Settings → Agents**section in your KloudMate account.**Step 2:**Select**Docker**from the list of available integrations.**Step 3:** Copy and run the Docker agent install command in your terminal to download and install the agent.
...
## **Next Steps**- Open**Infrastructure Monitoring** to see all running containers and host metrics
