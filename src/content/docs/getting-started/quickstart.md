...
See the [Monitor a web service](/tutorials/monitor-web-service) tutorial for a complete end-to-end example.

## Troubleshooting

If no data appears after ten minutes, check the [Common issues](/troubleshooting/common-issues) guide.
