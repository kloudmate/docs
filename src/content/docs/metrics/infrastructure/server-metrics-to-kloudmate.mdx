...
**Install the KloudMate Agents**on the server where metric monitoring is required. Refer to the [KloudMate Agents](../../../km-agent/) guide for detailed setup instructions.**Step 1: Access Agents and OpenTelemetry Collector Configuration**
