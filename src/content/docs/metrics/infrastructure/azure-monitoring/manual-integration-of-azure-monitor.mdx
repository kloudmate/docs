...
2. KloudMate Agent installed on the server scraping Azure Monitor metrics (see agent installation for [Linux Agent](/km-agent/installation/linux-agent/) and [Windows Agent](/km-agent/installation/windows-agent/)).
