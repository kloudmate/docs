...
Users can connect multiple AWS accounts with KloudMate. It takes **less than 5 minutes to connect the AWS account(s) and set up KloudMate**. Once the setup is complete, KloudMate automatically starts monitoring your synced services, pulls in the logs, traces, and metrics either through OpenTelemetry or CloudWatch, and weaves a comprehensible data fabric for the developers that is presented using visualizations.
 ...
 [Click here ](../../../getting-started/setting-up-kloudmate/)to link your AWS account with KloudMate.

### Managing AWS Account(s) 
KloudMate lets you view, add, [delete](../deleting-your-aws-account-from-kloudmate/), and edit **all the linked AWS account(s) under one window.**
...
- To add multiple AWS accounts, go to **Settings > Data sources**- Click on the**Connect AWS Account**button located at the top right corner
...
### **Managing Sync Settings for Each AWS Account**- Navigate to the data sources screen by clicking on**Settings > Data sources**
...
- Navigate to the **Sync Settings Screen**by clicking on **Settings > Sync settings.**- Click on the**Add Tags**button under Tag Filtering
