...
|---|---|---|
| [AWS](/integrations/aws) | Cloud | Ingest CloudWatch metrics, logs, and events |
| [Kubernetes](/integrations/kubernetes) | Container orchestration | Monitor clusters, nodes, and pods |
| [OpenTelemetry](/integrations/opentelemetry) | Standard | Send traces, metrics, and logs via OTLP |
