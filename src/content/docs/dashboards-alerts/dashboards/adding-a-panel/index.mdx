...
For more information on setting up queries, see [Setting Up KloudMate Alarms](/dashboards-alerts/alarms/setting-up-kloudmate-alarms/). For expressions, see [Writing Expressions for KloudMate Alarms](/dashboards-alerts/alarms/writing-expressions-for-kloudmate-alarms/).
