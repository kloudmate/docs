...
For more information on setting up queries, see [Setting Up KloudMate Alarms](../../alarms/setting-up-kloudmate-alarms/). For expressions, see [Writing Expressions for KloudMate Alarms](../../alarms/writing-expressions-for-kloudmate-alarms/).
