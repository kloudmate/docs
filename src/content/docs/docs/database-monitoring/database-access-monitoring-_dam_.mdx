...
description: "Documentation for Database Access Monitoring (DAM)"
---
...
- The eBPF Receiver must be enabled in the agent configuration (see [Configuration](<././KloudMate Agents/Configuration.mdx>))
