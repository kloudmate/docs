...
•  KloudMate Agent installed on the OracleDB host (see agent installation for [Linux](https://docs.kloudmate.com/linux-agent) and [Windows](https://docs.kloudmate.com/windows-agent))
...
## **Configuration Overview**###**Step 1: Access Agents and OpenTelemetry Collector Configuration**
...
2. Navigate to **Explore**3. Select**OpenTelemetry → Metrics**
