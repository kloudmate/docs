...
---
![image](./images/postgresql-monitoring-1.png)
...
4. KloudMate Agent installed on the PostgreSQL host
   - Refer to Agent installation for [Linux](https://docs.kloudmate.com/linux-agent) or [Windows](https://docs.kloudmate.com/windows-agent)
5. PostgreSQL username and password
6. PostgreSQL logging [enabled](https://docs.kloudmate.com/enable-logging-in-postgresql) from configurations
...
### **Step 5: Save Configuration and Restart Agent**After updating the configuration, click**Save Configuration** in the KloudMate UI.
