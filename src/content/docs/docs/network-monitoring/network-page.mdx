---
title: "Using Network Monitoring"
description: "Read the Overview, drill into devices, and understand device statuses in KloudMate Network Monitoring."
sidebar:
  label: "Using Network Monitoring"
  order: 5
---

Once devices are reporting, you watch them in **Network Monitoring**. It opens on the **Overview** tab, built to answer one question fast: is anything wrong, and where? From there you can drill into any device. This page explains how to read each surface.
