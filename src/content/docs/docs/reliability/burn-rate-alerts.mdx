...
Default sort is **firing-first** — currently-firing alerts at the top (longest-firing first), then grouped by SLO. The **Firing for Xh** chip on a row indicates how long the alert has been firing.
