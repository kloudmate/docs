...
You need the **Developer** role to create, edit, or delete SLOs and burn-rate alerts. With the **Viewer** role, you can view every reliability page, but the create, edit, and delete actions are hidden.
