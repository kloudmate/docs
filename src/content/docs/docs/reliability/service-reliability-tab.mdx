...
On incident detail (`/<workspaceId>/im/incidents/<id>`), a **Linked SLOs** panel appears below the **Service**, **Alert source**, and **Escalation policy** labels, but only when the affected service has at least one **Incident availability** SLO.
