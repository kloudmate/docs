...
To start a new investigation, click the **New Investigation** button in the top-right corner of the Investigations page. This brings you to the Investigations chat interface where you can describe the issue or symptom you want analyzed in the input bar at the bottom of the screen. The KloudMate Investigator collects your description and begins a background RCA workflow.
