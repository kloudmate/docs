...
- **KloudMate Dashboarding:** Drafts dashboards and alerts on your behalf. For example, you can say "Create a dashboard for Kubernetes" and the Assistant will generate a structured, ready-to-use dashboard.
