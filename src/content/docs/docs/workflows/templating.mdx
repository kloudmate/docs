...
**Reveal value** shows the plaintext to whoever created it, or to an organization **Owner**. Other users with the **Developer** role can't, even though they can rotate or delete it. Each reveal is recorded, along with who read it.
