...
A published workflow with a manual or form trigger gets a **Run** button. Fill in the trigger's input parameters and it starts a real run. Workspace admins can always do this; a member can when the workflow is set to allow it.
