...
Subsequently, monitor the metrics on the KloudMate dashboard and set up an alert to receive notifications if the potential metrics for a specific application rise.
