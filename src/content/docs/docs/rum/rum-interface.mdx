---
title: "RUM Interface"
description: "Explore, analyze, and visualize your Real User Monitoring data in KloudMate."
---

The RUM Interface is where you process, analyze, and visualize your Real User Monitoring data. It shows statistics, interactive graphs, and detail on how users interact with your application or website.

To integrate Real User Monitoring, visit [Instrumentation Guide](../instrumentation-guide/).
