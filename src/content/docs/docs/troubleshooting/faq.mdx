...
Yes. The Free plan supports up to 3 users, 7-day data retention, and the most commonly used integrations. See [Billing overview](/docs/billing/overview) for details.
...
KloudMate supports over 200 AWS services through CloudWatch. See the [AWS integration](/docs/integrations/aws) guide for details.
