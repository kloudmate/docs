...
5. **Add Queries and Expressions**
   ...
   Use **Add Expression** to derive values from existing queries, including math, reduce, and condition expressions. See [Writing Expressions for KloudMate Alarms](../../alarms/expressions/) for the full expression syntax.
