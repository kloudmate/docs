...
description: "Configure and use the Alert List panel in KloudMate dashboards."
---
The Alert List Panel displays a list of configured alert rules within the selected time range. The list can be filtered based on available attributes to focus on specific alerts relevant to your dashboard.

When the panel type is set to Alerts List, the following settings are available under the **General** tab:

![Alert List panel settings](./images/alarm-list-panel-1.jpeg)
