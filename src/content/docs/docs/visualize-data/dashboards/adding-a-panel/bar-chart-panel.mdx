...
![image](./images/bar-chart-panel-4.png)
...
Switching **Orientation** to Horizontal renders the bars sideways, useful when category labels are long or when you have many categories to compare.
