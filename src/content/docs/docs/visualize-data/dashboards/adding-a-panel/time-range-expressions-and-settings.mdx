...
description: "Configure dynamic time windows and panel-specific time overrides."
sidebar:
  order: 99
---
...
Access panel-level time range settings from the **General** tab's **Time Range** section in the right-side panel editor. These settings let you configure the time range independently for individual panels.
...
- **Supported operators:** `-` (subtract time)
