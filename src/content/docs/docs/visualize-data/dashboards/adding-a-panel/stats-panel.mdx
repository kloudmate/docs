...
### Rename
Click **Add** to rename a field for display, mapping its raw name to the label you want shown in the panel.
...
- **Graph mode:** Show the value alone (None) or with a small area chart behind it (Area).
...
![image](./images/stats-panel-4.jpeg)
