...
sidebar:
  ...
  order: 1
---
Kubernetes Monitoring in KloudMate gives you visibility into cluster health, workload availability, resource usage, pod behavior, and related telemetry collected by the KM Agent.
...
Use the [Kubernetes Agent installation guide](../../../km-agent/installation/kubernetes-agent/) to deploy the KM Agent into your cluster.

<hint type="info">
  The same installation flow supports self-managed Kubernetes and managed services such as AKS, EKS, and GKE.
</hint>
...
- [Explore](../../explore/) for ad hoc queries
...
- [KM Agent APM Setup Instructions](../../../km-agent/installation/kubernetes-agent/#apm-setup-instructions)
...
KloudMate also provides prebuilt dashboard templates for common Kubernetes views. See [Create a Dashboard](../../../dashboards/create-a-dashboard/) for template usage.
