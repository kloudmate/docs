...
1. The OpenTelemetry Collector must be [installed](https://docs.kloudmate.com/installing-the-opentelemetry-collector) and running. It is recommended that the collector be run on the same server as Prometheus.
