...
**Install the KloudMate Agents** on the server where metric monitoring is required. Refer to the [KloudMate Agents](<././KloudMate Agents.mdx>) guide for detailed setup instructions.
