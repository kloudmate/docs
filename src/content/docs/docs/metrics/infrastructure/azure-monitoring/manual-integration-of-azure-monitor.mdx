...
2. KloudMate Agent installed on the server scraping Azure Monitor metrics (see agent installation for [Linux Agent](<./././KloudMate Agents/Installation/Installation/Linux Agent.mdx>) and [Windows Agent](<./././KloudMate Agents/Installation/Installation/Windows Agent.mdx>)).
...
**Step 2:  Step 4:  Save Configuration and Restart Agent**
