...
![Recurring daily schedule with a time, a timezone, and the dates the next run will cover](./images/create-report-4.png)
...
![Recipients and report details steps](./images/create-report-5.png)
