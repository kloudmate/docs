...
- **Report Type:** Select the type of report to generate — [Alert Report](../alert-report/), [Incident Report](../incident-report/), [Dashboard Report](../dashboard-report/), or [SLO Compliance](../../reliability/slo-compliance-report/). When generating an Alert Report, you can also filter alerts by labels or select specific alerts using the dropdown.
