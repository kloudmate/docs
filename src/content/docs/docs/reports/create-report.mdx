...
- **Report Type:** Select the type of report to generate — [Alarm Report](../alarm-report/), [Incident Report](../incident-report/), or [Dashboard Report](../dashboard-report/). You can also filter alarms by tags or select specific alarms using the dropdown.
