...
| **Your account isn't set up for this org — ask an organization Owner to invite you** (`UserNotProvisioned` / `UserNotInOrg`) | Provisioning is **invite-only** and this person wasn't invited | [Invite them](../../users-permissions/), or switch provisioning to **JIT** — see [Provisioning & enforcement](../provisioning-and-enforcement/) |
