...
- **External and guest collaborators are not forced through your IdP.** A collaborator whose email is on a *different* domain — a contractor on their own company's domain, say — keeps normal password login. Your IdP only governs your own domains.
