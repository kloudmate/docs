...
![User provisioning options](./images/user-provisioning-card.png)

### Which one should you pick?

- Use **Invite only** when you want to control the member list yourself and treat the IdP purely as the login method. A user who authenticates but was never invited is turned away with **Your account isn't set up for this org — ask an organization Owner to invite you.**
