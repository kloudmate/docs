...
Open **Settings → Connections** and click **Connect**. Connecting is a workspace admin action.
...
**Workspace** is the default and almost always the right choice. The connection belongs to the workspace, so any admin can use and manage it, and it keeps working when whoever connected it leaves.
