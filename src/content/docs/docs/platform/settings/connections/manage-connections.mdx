...
Every action here is on the row menu in **Settings → Connections**, and all of them are workspace admin actions.
...
A **workspace** connection belongs to the workspace, so any workspace admin can edit, rotate, or delete it, and it outlives whoever connected it.
