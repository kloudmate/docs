...
2. You'll be redirected to Slack's OAuth flow. Pick the channel KloudMate should post into and approve the bot scopes.
...
Behind the scenes KloudMate creates two rows in a single shot:
