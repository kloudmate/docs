...
description: "Documentation for Pie Chart Panel"
---
...
Choose between **Pie** and **Donut** as the chart style. Use the **Labels** setting to control what is shown on the chart slices, options include Value, Percentage, and Name.
