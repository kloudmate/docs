...
description: "Documentation for Dashboard Details"
---
...
**Step 1:** Open the dashboard and click the more options icon, then select **Share**. This copies the dashboard as a JSON to your clipboard.

![image](./images/dashboard-details-4.jpeg)

**Step 2:** Navigate to the Dashboards section in the target workspace, click **Import**, paste the copied JSON, and click **Submit**. The dashboard will be recreated as a replica in the new workspace.
