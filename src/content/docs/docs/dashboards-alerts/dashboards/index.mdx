...
**Step 2:** Click the **Copy** button next to the Template JSON block to copy the full JSON definition.

**Step 3:** In KloudMate, click the **Import** button at the top-right of the Dashboards screen.
