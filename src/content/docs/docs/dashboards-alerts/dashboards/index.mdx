---
title: "Dashboards"
description: "Documentation for Dashboards Overview"
sidebar:
  label: "Introduction"
---
...
**Step 1:** Click **Create Folder** at the top of the Dashboards screen.

![image](./images/dashboards-overview-2.png)

**Step 2:**Enter a**Folder Name**and an optional**Description**, then click**Create**. 
...
- **Delete:**evoke access. Deleting the link will make it stop working immediately.***
...
**Step 1:** Open the [KloudMate Dashboard Templates](https://templates.kloudmate.com/) site and find the template you want to use (e.g., Kubernetes Cluster Dashboard). The page shows a dashboard preview followed by a Template JSON section.

![image](./images/dashboards-overview-2.jpeg)

**Step 2:**Click the**Copy**button next to the Template JSON block to copy the full JSON definition.**Step 3:**In KloudMate, click the**Import** button at the top-right of the Dashboards screen.

![image](./images/dashboards-overview-3.jpeg)

**Step 4:**aste the copied JSON into the Import Dashboard dialog and click**Submit**.
