...
description: "Documentation for Managing Dashboards"
sidebar:
  label: "Introduction"
---
## Entering Edit Mode
...
- **Delete Dashboard:** ermanently delete the dashboard.
...
**Step 1:**Click the **Variables**tab in Dashboard Settings.**Step 2:**Enter a**Name**,**Label**, and**Description**for the variable.**Step 3:**Select the **Variable Type**:
...
- **Constant:**Sets a fixed value that remains unchanged across the dashboard.**Step 4:**Click **Save**.
