...
**Prerequisite:**A Jira notification channel must already be configured.**Step 1:**Navigate to the**Issue**or**Alarm** details page.
...
**Step 3:**Under Jira Channels, select the checkbox(es) for the channel(s) you want to raise a ticket in.**Step 4:**Click**Create Ticket**.
...
**Step 2:**The panel displays all Jira tickets currently linked to the issue, showing the Ticket ID, Site, Project, and Issue Type.**Step 3:**Click the**unlink** icon next to the ticket you want to remove to unlink it from KloudMate.
