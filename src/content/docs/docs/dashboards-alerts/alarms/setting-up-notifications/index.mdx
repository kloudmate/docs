...
To learn how to create a KloudMate alarm, see [Setting Up KloudMate Alarms](<./Setting Up KloudMate Alarms.mdx>).
...
**Step 1:** Click the **Create** button at the top-right corner.

**Step 2:** Select the desired channel type from the dropdown.

![image](./images/setting-up-notifications-1.png)

**Step 3:** Enter a **Name** and the corresponding **Address** (e.g., email address or webhook URL) for the channel.
...
**Step 4:** Click **Add condition** to define when this policy should trigger. You can add multiple conditions to a single policy.
...
**Step 5:** Use the **Disable this policy** toggle if you want to save the policy without activating it immediately.
...
- [Setting Up KloudMate](https://docs.kloudmate.com/setting-up-kloudmate-alarms)
