...
For more information on setting up queries, see [Setting Up KloudMate Alarms](../../alerts/setting-up-kloudmate-alarms/). For expressions, see [Writing Expressions for KloudMate Alarms](../../alerts/writing-expressions-for-kloudmate-alarms/).
...
**Step 8:** Use the time range picker at the top to set the time window for this panel.
