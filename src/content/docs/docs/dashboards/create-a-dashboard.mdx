...
description: "Documentation for Create a Dashboard"
sidebar:
  order: 2
---
...
**Step 1:** From the Dashboards screen, click **Create Dashboard**.

![image](./images/create-a-dashboard-1.jpeg)

**Step 2:** Choose how you want to create the dashboard:
