...
title: "HTTP Monitor"
description: "Monitor web endpoints and APIs with a synthetic HTTP monitor."
sidebar:
  label: "HTTP Monitor"
---
...
1. Open **Synthetic Monitoring → Monitors**.
2. Click **Add New**.
...
- **Monitoring Locations**
  Choose one or multiple locations from which the checks will be executed. Selecting multiple locations is recommended to reduce false positives.
...
Assertions define the conditions the monitor validates against the HTTP responses. You can configure multiple assertions to cover more conditions:
...
[SSL Certificate Validity Monitor - Check SSL Certificate Expiration and Validity](../ssl-monitor/)
