...
Click **Open service page** at the bottom of the panel to navigate to that service's APM dashboard, where you can inspect request trends, latency percentiles, traces, issues, alarms, and dashboards in more detail.
