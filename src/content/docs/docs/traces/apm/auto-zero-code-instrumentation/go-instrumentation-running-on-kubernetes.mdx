---
title: "Go Instrumentation (Running on Kubernetes)"
description: "Documentation for Go Instrumentation (Running on Kubernetes)"
---
...
BASH
  ...
  ```none
  kubectl patch deployment <deployment-name> -n <namespace> -p '{"spec":{"template":{"metadata":{"annotations":{"instrumentation.opentelemetry.io/inject-go": "true"}}}}}' 
  ```
