...
| @type              | Type of message in your log: <br />*Report - Log line contains REPORT* Start - Log line contains START* End - Log line contains END        |
| @functionError     | Lambda invocation errors, such as:<br />*crash  (Unhandled error)* timeout  (Function timed out)* early\_exit  (Runtime exited with error) |
