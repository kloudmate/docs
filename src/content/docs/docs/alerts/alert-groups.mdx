...
Each affected resource sits at the center of its own graph, with neighbours branching off along labeled edges: **runs on**, **talks to**, **calls**. Neighbours of the same kind collapse into one node (*116 Pods · runs on*) that you click to list them.
