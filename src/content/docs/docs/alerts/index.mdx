...
For how these states transition — and how the pending duration, recovery period, and no-data / error settings shape them — see [Alert Lifecycle & States](./alert-lifecycle/).
