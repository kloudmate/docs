...
![Routing rule editor with Alert grouping set to Auto (AI), which hides the Group by keys and the Alerts this rule matches preview](./images/routing-rules-alert-grouping.png)
