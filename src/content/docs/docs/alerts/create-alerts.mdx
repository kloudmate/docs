...
![A rule's more options menu with Edit, Duplicate, Move to folder, Export as JSON, State history, Pause Evaluation, Pause Notifications, and Delete](./images/setting-up-kloudmate-alarms-1.jpeg)
