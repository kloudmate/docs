...
<hint type="info">
  system * is required for automatic service configuration.*
</hint>
...
1. **Choose the Correct Version:** Select the appropriate version of the OpenTelemetry Collector for Windows. Each Collector [release ](https://github.com/open-telemetry/opentelemetry-collector-releases/releases)includes an otelcol-contrib.exe executable that you can run after unpacking.
2. **Run the Installer:**
