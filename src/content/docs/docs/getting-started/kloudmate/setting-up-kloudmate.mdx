...
- For detailed steps on installing and configuring agents, refer to the [KloudMate Agents](<././KloudMate Agents.mdx>) documentation.
- For a complete guide on sending data directly using OpenTelemetry, click [Using OpenTelemetry Collector](<././OpenTelemetry Support /Using OpenTelemetry Collector.mdx>).
