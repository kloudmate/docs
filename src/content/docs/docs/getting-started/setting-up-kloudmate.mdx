...
- For detailed steps on installing and configuring agents, refer to the [KM Agent](../../km-agent/) documentation.
- For a complete guide on sending data directly using OpenTelemetry, click [Using OpenTelemetry Collector](../../opentelemetry/).
