...
1. The [KloudMate Agent](../../../kloudmate-agent/) deployed and running in the cluster.
...
- If the agent runs in managed mode, add the configuration below through the [custom config override](../../../kloudmate-agent/custom-config-override/) section for the deployment collector.
