...
resource "aws_lambda_function" "my_function" {
  ...
  layers = [
    "arn:aws:lambda:us-east-1:429321095007:layer:lambda-telemetry-extension:2",
  ]
...
aws lambda update-function-configuration \
  ...
  --layers arn:aws:lambda:us-east-1:429321095007:layer:lambda-telemetry-extension:2 \
