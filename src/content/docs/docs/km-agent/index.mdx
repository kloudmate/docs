...
- **Windows** (Windows Server 2016+)
    ...
    ### [Linux Agent](./installation/linux-agent.mdx)
  

  

    ### [Docker Agent](./installation/docker-agent.mdx)
  

  

    ### [Windows Agent](./installation/windows-agent.mdx)
  

  

    ### [Kubernetes Agent](./installation/kubernetes-agent.mdx)
