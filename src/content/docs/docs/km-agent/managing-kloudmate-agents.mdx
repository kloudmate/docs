...
<hint type="info">
  ...
  [Linux Agent](<./Installation/Installation/Linux Agent.mdx>) | [Docker Agent](<./Installation/Installation/Docker Agent.mdx>) | [Windows Agent](<./Installation/Installation/Windows Agent.mdx>) | [Kubernetes Agent](<./Installation/Installation/Kubernetes Agent.mdx>)
</hint>
