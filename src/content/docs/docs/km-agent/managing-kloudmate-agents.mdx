...
<hint type="info">
  ...
  [Linux Agent](../installation/linux-agent/) | [Docker Agent](../installation/docker-agent/) | [Windows Agent](../installation/windows-agent/) | [Kubernetes Agent](../installation/kubernetes-agent/)
</hint>
