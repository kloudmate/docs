...
For a clearer end-user guide on when to use eBPF, where the data appears, and how it relates to APM and database monitoring, see [eBPF Observability](../ebpf-observability/).
