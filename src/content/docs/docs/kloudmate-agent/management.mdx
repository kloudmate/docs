...
You manage the KloudMate Agent centrally from the web UI, so you don't need to SSH into your servers or edit local YAML files. Changes you make in the dashboard are pushed to your agents automatically.
