...
- **Manual mode:** you own the raw YAML, and the feature toggles are disabled. This is the advanced escape hatch for hand-tuned setups.
...
KloudMate keeps the recent generated configurations for each agent. If a change causes a problem, you can review the history and roll back to an earlier configuration.
