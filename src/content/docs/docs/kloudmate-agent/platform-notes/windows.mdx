...
Alongside application instrumentation, the agent automatically collects Windows host metrics (CPU, memory, disk, and network usage) and the ETW server spans and request-duration metrics described above.
