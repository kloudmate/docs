...
**Step 2:** Click **Add Agent**, select **Docker**, and click **Continue**. On the **API key** step, click **Create backend key**, or select **Use existing key** and paste your backend ingest key. Then click **Continue**.
...
- Open **Hosts** to see all running containers and host metrics
- Go to **Dashboards** to visualize container and host performance
- Use **Logs** to investigate container logs and host logs
