...
**Step 2:** Click **Add Agent**, select **Windows**, and click **Continue**. On the **API key** step, click **Create backend key**, or select **Use existing key** and paste your backend ingest key. Then click **Continue**.
...
- Open **Hosts** to see host metrics
- Go to **Dashboards** to visualize host performance and logs
- Set up [log monitoring](../../log-monitoring/), then use **Logs** to investigate the logs it collects
