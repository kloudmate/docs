...
- eBPF does not apply on Windows. The agent provides an equivalent monitoring through Event Tracing for Windows (ETW). See [Windows platform notes](../../platform-notes/windows/).
