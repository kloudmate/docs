...
:::note
Once an instance's agent checks in, it starts in managed mode and begins collecting host metrics, logs, and the [eBPF monitoring](../../ebpf-observability/) automatically. See the [configuration model](../../concepts/config-model/) and [host metrics and logs](../../baseline/host-metrics-and-logs/).
:::
