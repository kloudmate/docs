...
:::note
However you provision it, each agent starts in managed mode and collects host metrics, logs, and the [eBPF monitoring](../../ebpf-observability/) automatically once it checks in. See the [configuration model](../../concepts/config-model/).
:::
