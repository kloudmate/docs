...
description: "Deploy the KloudMate agent with cloud-init, Ansible, Terraform, or Packer across any cloud provider or on-premises."
sidebar:
  order: 8
---
...
:::note
However you install it, each agent starts in managed mode. Once it checks in, it automatically collects host metrics, logs, and [eBPF monitoring](../../ebpf-observability/) data. See the [configuration model](../../concepts/config-model/).
:::
