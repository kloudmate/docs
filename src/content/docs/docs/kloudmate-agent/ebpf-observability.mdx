...
- **Network topology:** host-to-host Layer 4 flow edges, built from the peer addresses on each flow. See [eBPF network topology](../ebpf-network-topology/).
...
<CardGrid>
  ...
  <LinkCard title="Network topology (eBPF)" href="../ebpf-network-topology/" description="Host-to-host network edges built from eBPF flows." />
