...
:::note
In the **Application instrumentation** card, a Go service offers **Off** and **eBPF** but not **SDK**. eBPF is already tracing it at the kernel level, so there's no in-process agent to add.
:::
