...
:::note
PHP and Go work differently. PHP is reloaded gracefully instead of restarted; see [PHP instrumentation](../php/). Go is not attached at all; it is covered by the [eBPF baseline](../go-ebpf/).
:::
