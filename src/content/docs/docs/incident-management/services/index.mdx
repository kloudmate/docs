...
**Incidents → Services** lists each service with its name, description, owner, default escalation policy, and current health.
...
You can add an alert source directly from the service page with **Add Source**, and click **Edit** or **Archive** to update or archive the service.
