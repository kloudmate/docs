...
Screenshot pending — a service detail page with its incident counts and the alert sources table (name, description, type, escalation policy).
:::
![Service detail with alert sources](../../_placeholders/screenshot-placeholder.png)
