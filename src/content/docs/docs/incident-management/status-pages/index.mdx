...
:::note[Availability]
Status pages are a paid Incident Management feature. If you don't see a **Status pages** tab in **Incidents**, your plan doesn't include it yet. Contact your account team to turn it on.
:::
...
<Steps>
1. Open **Incidents → Status pages** and click **Create Status Page**.
...
![Status page editor Components tab](./images/status-page-components-tab.png)
...
![Status Pages list](./images/status-pages-list.png)
