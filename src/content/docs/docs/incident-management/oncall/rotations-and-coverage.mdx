...
:::note[Availability]
On-call schedules are a paid Incident Management feature. If you don't see an **On-call** tab in **Incidents**, your plan doesn't include it yet. Contact your account team to turn it on.
:::
...
![Rotation coverage settings](./images/rotation-coverage-settings.png)
...
![Business-hours and after-hours rotations](./images/schedule-split-rotations.png)
