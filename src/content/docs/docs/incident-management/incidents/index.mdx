...
Screenshot pending — the incident list with the bulk-action toolbar and the service / alert source / escalation policy filters.
:::
![Incident list with filters and bulk actions](../../_placeholders/screenshot-placeholder.png)
