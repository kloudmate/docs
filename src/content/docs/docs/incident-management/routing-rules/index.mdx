...
- **Notify on-call schedules** — page whoever is on call on one or more [schedules](../oncall/).
...
| Notify on-call schedules | Pages the people on call on the named schedules | **Accumulates** across every matching rule |
