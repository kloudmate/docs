...
:::note[Availability]
Routing rules are a paid Incident Management feature. If you don't see a **Routing rules** tab in **Incidents**, your plan doesn't include it yet. Contact your account team to turn it on.
:::
...
![Routing rule editor with match conditions](./images/rule-editor-conditions.png)
...
![Routing rule action picker](./images/rule-action-picker.png)
...
![Routing rule tester with a decision result](./images/rule-tester.png)

## Create a routing rule

<Steps>
1. Open **Incidents → Routing rules** and click **Add Rule**.
