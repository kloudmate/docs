...
<Steps>
1. Log into the KloudMate Console and open **Incidents → Alert sources**.

2. Click **Add Source** (or open a specific [service](../../services/) and click **Add Source** in its **Alert Sources** section).
...
![Create CloudWatch alert source](./images/cloudwatch-alert-source-1.png)

![CloudWatch alert source URL](./images/cloudwatch-alert-source-2.png)
